...
export function getCourseCapacity(id,date){
...
export function updateCourseCapacity(id,date,capacity){
    return new Promise((resolve, reject) => {
...
export function deleteFromWaiting(user,date,courseRef){
    return new Promise((resolve, reject) => {
...
export function insertDeletedRow(Course_Ref,Name,Date,DateDeadline,Capacity){
    return new Promise(((resolve, reject) => {
...
export function restoreTypeLecture(Course_Ref,Date){
    return new Promise((resolve, reject) => {
