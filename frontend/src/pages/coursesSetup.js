                        ...
                        <div className="accordion-custom-setup-1">
                            <Accordion.Toggle as={Card.Header} onClick={(e) => {e.preventDefault();}} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none"}}>
                                <div style={{display: "flex",  flexWrap: "nowrap", justifyContent: "flex-start", alignItems: "cnter", marginTop: "13px"}}>
                                    ...
                                    <p style={{fontStyle: "italic", marginLeft: "17px", marginTop: "1px", color: "#bababa"}}>{courses.filter(course=>(course.year===year.year&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", marginLeft: "5px", marginTop: "1px", color: "#bababa"}}>remote courses,</p>
                                            ...
                                            <div className="accordion-custom-setup-1">
                                                <Accordion.Toggle as={Card.Header} onClick={(e) => { e.preventDefault(); }} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none", height: "48px"}}>
                                                    <div style={{ display: "flex", flexWrap: "nowrap", justifyContent: "flex-start"}}>
                                                        Semester 1
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "17px", color: "#bababa", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===1&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#bababa", marginTop: "2pt"}}>remote courses,</p>
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "7px", color: "#bababa", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===1&&course.restriction===0)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#bababa", marginTop: "2pt"}}>courses in presence</p>
                                                    </div>
                                                </Accordion.Toggle>
                                        ...
                                        <Card>
                                            <div className="accordion-custom-setup-1">
                                                <Accordion.Toggle as={Card.Header} onClick={(e) => { e.preventDefault(); }} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none", height: "48px"}}>
                                                    <div style={{ display: "flex", flexWrap: "nowrap", justifyContent: "flex-start" }}>
                                                        Semester 2
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "17px", color: "#bababa", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===2&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#bababa", marginTop: "2pt"}}>remote courses,</p>
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "7px", color: "#bababa", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===2&&course.restriction===0)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#bababa", marginTop: "2pt"}}>courses in presence</p>                                                    </div>
                                                </Accordion.Toggle>
