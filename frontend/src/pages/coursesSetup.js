                        ...
                        <div className="accordion-custom-setup-1">
                            <Accordion.Toggle as={Card.Header} onClick={(e) => {e.preventDefault();}} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none"}}>
                                <div style={{display: "flex",  flexWrap: "nowrap", justifyContent: "flex-start", alignItems: "cnter", marginTop: "13px"}}>
                                    ...
                                    <p style={{fontStyle: "italic", marginLeft: "17px", marginTop: "1px", color: "#949494"}}>{courses.filter(course=>(course.year===year.year&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", marginLeft: "5px", marginTop: "1px", color: "#949494"}}>remote courses,</p>
                                    <p style={{fontStyle: "italic", marginLeft: "7px", marginTop: "1px", color: "#949494"}}>{courses.filter(course=>(course.year===year.year&&course.restriction===0)).length}</p><p style={{fontStyle: "italic", marginLeft: "5px", marginTop: "1px", color: "#949494"}}>courses in presence</p>
                                </div>
                            </Accordion.Toggle>
                                            ...
                                            <div className="accordion-custom-setup-1">
                                                <Accordion.Toggle as={Card.Header} onClick={(e) => { e.preventDefault(); }} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none", height: "48px"}}>
                                                    <div style={{ display: "flex", flexWrap: "nowrap", justifyContent: "flex-start"}}>
                                                        Semester 1
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "17px", color: "#949494", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===1&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#949494", marginTop: "2pt"}}>remote courses,</p>
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "7px", color: "#949494", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===1&&course.restriction===0)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#949494", marginTop: "2pt"}}>courses in presence</p>
                                                    </div>
                                                </Accordion.Toggle>
                                        ...
                                        <Card>
                                            <div className="accordion-custom-setup-1">
                                                <Accordion.Toggle as={Card.Header} onClick={(e) => { e.preventDefault(); }} eventKey="0" style={{width: "97%", backgroundColor: "#F7F7F7", borderStyle: "none", height: "48px"}}>
                                                    <div style={{ display: "flex", flexWrap: "nowrap", justifyContent: "flex-start" }}>
                                                        Semester 2
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "17px", color: "#949494", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===2&&course.restriction===1)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#949494", marginTop: "2pt"}}>remote courses,</p>
                                                        <p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "7px", color: "#949494", marginTop: "2pt"}}>{courses.filter(course=>(course.year===year.year&&course.semester===2&&course.restriction===0)).length}</p><p style={{fontStyle: "italic", fontSize: "13px", marginLeft: "5px", color: "#949494", marginTop: "2pt"}}>courses in presence</p>                                                    </div>
                                                </Accordion.Toggle>
